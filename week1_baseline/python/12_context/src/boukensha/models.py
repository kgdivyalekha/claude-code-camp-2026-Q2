...
# not a value the user sets. The agent looks it up from its configured model
# id; the user never configures it in settings.yaml. Unknown models fall back
# to a conservative default so an unrecognised id can't silently assume a
# huge window.
